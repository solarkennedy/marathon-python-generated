...
var slConverter = require('api-spec-converter'), //Warning: not published to npm yet
    fs = require('fs')
ramlToSwaggerConverter = new slConverter.Converter(slConverter.Formats.RAML, slConverter.Formats.RAML)
ramlToSwaggerConverter.loadFile('api.raml', function(err){
  ...
  .then(function(convertedData){
    fs.writeFileSync('../../../../../../marathon-raml.yaml', convertedData, 'utf8');
  })
  .catch(function(err){
    console.log(err);
  })
