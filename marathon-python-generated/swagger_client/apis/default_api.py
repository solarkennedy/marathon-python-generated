...
class DefaultApi(object):
    ...
    def metrics_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.metrics_get(callback=callback_function)
    ...
    def ping_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.ping_get(callback=callback_function)
    ...
    def v2_apps_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_get(callback=callback_function)
    ...
    def v2_apps_put(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_put(callback=callback_function)
    ...
    def v2_apps_post(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_post(callback=callback_function)
    ...
    def v2_apps_app_id_get(self, app_id, **kwargs):
        """
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_get`")
    ...
    def v2_apps_app_id_put(self, app_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_put(app_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_put" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_put`")
    ...
    def v2_apps_app_id_delete(self, app_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_delete(app_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_delete`")
    ...
    def v2_apps_app_id_restart_post(self, app_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_restart_post(app_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_restart_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_restart_post`")
    ...
    def v2_apps_app_id_tasks_get(self, app_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_tasks_get(app_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_tasks_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_tasks_get`")
    ...
    def v2_apps_app_id_tasks_delete(self, app_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_tasks_delete(app_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_tasks_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_tasks_delete`")
    ...
    def v2_apps_app_id_tasks_task_id_delete(self, app_id, task_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_tasks_task_id_delete(app_id, task_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str app_id: app_id (required)
        :param str task_id: task_id (required)
        :param bool force: Only one deployment can be applied to one application at the same time. If the existing deployment should be canceled by this change, you can set force=true.\nCaution&#58; setting force=true will cancel the current deployment. This paramter should be used only, if the current deployment is unsuccessful!
        :param bool scale: If `scale=true` is specified, then the application is scaled down by the number of killed tasks.
        :return: None
                 If the method is called asynchronously,
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_tasks_task_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_tasks_task_id_delete`")
        # verify the required parameter 'task_id' is set
        if ('task_id' not in params) or (params['task_id'] is None):
            raise ValueError("Missing the required parameter `task_id` when calling `v2_apps_app_id_tasks_task_id_delete`")
    ...
    def v2_apps_app_id_versions_get(self, app_id, task_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_versions_get(app_id, task_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_versions_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_versions_get`")
        # verify the required parameter 'task_id' is set
        if ('task_id' not in params) or (params['task_id'] is None):
            raise ValueError("Missing the required parameter `task_id` when calling `v2_apps_app_id_versions_get`")
    ...
    def v2_apps_app_id_versions_version_get(self, app_id, task_id, version, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_apps_app_id_versions_version_get(app_id, task_id, version, callback=callback_function)
        ...
        all_params = ['app_id', 'task_id', 'version']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_apps_app_id_versions_version_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_apps_app_id_versions_version_get`")
        # verify the required parameter 'task_id' is set
        if ('task_id' not in params) or (params['task_id'] is None):
            raise ValueError("Missing the required parameter `task_id` when calling `v2_apps_app_id_versions_version_get`")
        # verify the required parameter 'version' is set
        if ('version' not in params) or (params['version'] is None):
            raise ValueError("Missing the required parameter `version` when calling `v2_apps_app_id_versions_version_get`")
    ...
    def v2_artifacts_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_artifacts_post(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_artifacts_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_artifacts_path_get(self, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_artifacts_path_get(path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_artifacts_path_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_artifacts_path_get`")
    ...
    def v2_artifacts_path_put(self, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_artifacts_path_put(path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_artifacts_path_put" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_artifacts_path_put`")
    ...
    def v2_artifacts_path_post(self, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_artifacts_path_post(path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_artifacts_path_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_artifacts_path_post`")
    ...
    def v2_artifacts_path_delete(self, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_artifacts_path_delete(path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_artifacts_path_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_artifacts_path_delete`")
    ...
    def v2_deployments_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_deployments_get(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_deployments_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_deployments_deployment_id_delete(self, deployment_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_deployments_deployment_id_delete(deployment_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str deployment_id: deployment_id (required)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_deployments_deployment_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('deployment_id' not in params) or (params['deployment_id'] is None):
            raise ValueError("Missing the required parameter `deployment_id` when calling `v2_deployments_deployment_id_delete`")
    ...
    def v2_event_subscriptions_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_event_subscriptions_get(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_event_subscriptions_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_event_subscriptions_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_event_subscriptions_post(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_event_subscriptions_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_event_subscriptions_delete(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_event_subscriptions_delete(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_event_subscriptions_delete" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_events_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_events_get(callback=callback_function)
        ...
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['text/event-stream', 'text/html'])
        if not header_params['Accept']:
            del header_params['Accept']
    ...
    def v2_groups_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_get(callback=callback_function)
    ...
    def v2_groups_put(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_put(callback=callback_function)
    ...
    def v2_groups_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_post(callback=callback_function)
    ...
    def v2_groups_delete(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_delete(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_delete" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_groups_versions_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_versions_get(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_versions_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_groups_group_id_get(self, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_group_id_get(group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_group_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `v2_groups_group_id_get`")
    ...
    def v2_groups_group_id_put(self, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_group_id_put(group_id, callback=callback_function)
        ...
        all_params = ['group_id', 'force', 'body']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_group_id_put" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `v2_groups_group_id_put`")
    ...
    def v2_groups_group_id_post(self, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_group_id_post(group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_group_id_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `v2_groups_group_id_post`")
    ...
    def v2_groups_group_id_delete(self, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_group_id_delete(group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_group_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `v2_groups_group_id_delete`")
    ...
    def v2_groups_group_id_versions_get(self, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_groups_group_id_versions_get(group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_groups_group_id_versions_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `v2_groups_group_id_versions_get`")
    ...
    def v2_info_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_info_get(callback=callback_function)
    ...
    def v2_leader_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_leader_get(callback=callback_function)
    ...
    def v2_leader_delete(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_leader_delete(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_leader_delete" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_plugins_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_plugins_get(callback=callback_function)
    ...
    def v2_plugins_plugin_id_path_get(self, plugin_id, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_plugins_plugin_id_path_get(plugin_id, path, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str plugin_id: plugin_id (required)
        :param str path: path (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_plugins_plugin_id_path_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('plugin_id' not in params) or (params['plugin_id'] is None):
            raise ValueError("Missing the required parameter `plugin_id` when calling `v2_plugins_plugin_id_path_get`")
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_plugins_plugin_id_path_get`")
    ...
    def v2_plugins_plugin_id_path_put(self, plugin_id, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_plugins_plugin_id_path_put(plugin_id, path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_plugins_plugin_id_path_put" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'plugin_id' is set
        if ('plugin_id' not in params) or (params['plugin_id'] is None):
            raise ValueError("Missing the required parameter `plugin_id` when calling `v2_plugins_plugin_id_path_put`")
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_plugins_plugin_id_path_put`")
    ...
    def v2_plugins_plugin_id_path_post(self, plugin_id, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_plugins_plugin_id_path_post(plugin_id, path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_plugins_plugin_id_path_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'plugin_id' is set
        if ('plugin_id' not in params) or (params['plugin_id'] is None):
            raise ValueError("Missing the required parameter `plugin_id` when calling `v2_plugins_plugin_id_path_post`")
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_plugins_plugin_id_path_post`")
    ...
    def v2_plugins_plugin_id_path_delete(self, plugin_id, path, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_plugins_plugin_id_path_delete(plugin_id, path, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_plugins_plugin_id_path_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'plugin_id' is set
        if ('plugin_id' not in params) or (params['plugin_id'] is None):
            raise ValueError("Missing the required parameter `plugin_id` when calling `v2_plugins_plugin_id_path_delete`")
        # verify the required parameter 'path' is set
        if ('path' not in params) or (params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `v2_plugins_plugin_id_path_delete`")
    ...
    def v2_queue_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_queue_get(callback=callback_function)
    ...
    def v2_queue_app_id_delay_delete(self, app_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_queue_app_id_delay_delete(app_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_queue_app_id_delay_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `v2_queue_app_id_delay_delete`")
    ...
    def v2_tasks_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_tasks_get(callback=callback_function)
    ...
    def v2_tasks_delete_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v2_tasks_delete_post(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_tasks_delete_post" % key
                )
            params[key] = val
        del params['kwargs']
