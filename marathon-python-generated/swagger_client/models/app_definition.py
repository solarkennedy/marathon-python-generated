...
class AppDefinition(object):
    ...
    def __init__(self):
        """
        AppDefinition - a model defined in Swagger
    ...
    def accepted_resource_roles(self):
        """
        Gets the accepted_resource_roles of this AppDefinition.
        ...
        :return: The accepted_resource_roles of this AppDefinition.
        :rtype: list[str]
        """
    ...
    def accepted_resource_roles(self, accepted_resource_roles):
        """
        Sets the accepted_resource_roles of this AppDefinition.
        Optional. A list of resource roles. Marathon considers only resource offers with roles in this list for launching tasks of this app. If you do not specify this, Marathon considers all resource offers with roles that have been configured by the `--default_accepted_resource_roles` command line flag. If no `--default_accepted_resource_roles` was given on startup, Marathon considers all resource offers. To register Marathon for a role, you need to specify the `--mesos_role` command line flag on startup. If you want to assign all resources of a slave to a role, you can use the `--default_role` argument when starting up the slave. If you need a more fine-grained configuration, you can use the `--resources` argument to specify resource shares per role. The Mesos master needs to be started with `--roles` followed by a comma-separated list of all roles you want to use across your cluster. See [the Mesos command line documentation](http://mesos.apache.org/documentation/latest/configuration/) for details.

        :param accepted_resource_roles: The accepted_resource_roles of this AppDefinition.
        :type: list[str]
        """
    ...
    def args(self):
        """
        Gets the args of this AppDefinition.
        ...
        :return: The args of this AppDefinition.
        :rtype: list[str]
        """
        return self._args
    ...
    def args(self, args):
        """
        Sets the args of this AppDefinition.
        An array of strings that represents an alternative mode of specifying the command to run. This was motivated by safe usage of containerizer features like a custom Docker ENTRYPOINT. This args field may be used in place of cmd even when using the default command executor. This change mirrors API and semantics changes in the Mesos CommandInfo protobuf message starting with version `0.20.0`.  Either `cmd` or `args` must be supplied. It is invalid to supply both `cmd` and `args` in the same app.

        :param args: The args of this AppDefinition.
        :type: list[str]
        """
        self._args = args
    ...
    def backoff_factor(self):
        """
        Gets the backoff_factor of this AppDefinition.
        ...
        :return: The backoff_factor of this AppDefinition.
        :rtype: float
        """
    ...
    def backoff_factor(self, backoff_factor):
        """
        Sets the backoff_factor of this AppDefinition.
        Configures exponential backoff behavior when launching potentially sick apps. This prevents sandboxes associated with consecutively failing tasks from filling up the hard disk on Mesos slaves. The backoff period is multiplied by the factor for each consecutive failure until it reaches maxLaunchDelaySeconds. This applies also to tasks that are killed due to failing too many health checks.

        :param backoff_factor: The backoff_factor of this AppDefinition.
        :type: float
        """
    ...
    def backoff_seconds(self):
        """
        Gets the backoff_seconds of this AppDefinition.
        Configures exponential backoff behavior when launching potentially sick apps. This prevents sandboxes associated with consecutively failing tasks from filling up the hard disk on Mesos slaves. The backoff period is multiplied by the factor for each consecutive failure until it reaches maxLaunchDelaySeconds. This applies also to tasks that are killed due to failing too many health checks.

        :return: The backoff_seconds of this AppDefinition.
        :rtype: int
        """
    ...
    def backoff_seconds(self, backoff_seconds):
        """
        Sets the backoff_seconds of this AppDefinition.
        Configures exponential backoff behavior when launching potentially sick apps. This prevents sandboxes associated with consecutively failing tasks from filling up the hard disk on Mesos slaves. The backoff period is multiplied by the factor for each consecutive failure until it reaches maxLaunchDelaySeconds. This applies also to tasks that are killed due to failing too many health checks.

        :param backoff_seconds: The backoff_seconds of this AppDefinition.
        :type: int
        """
    ...
    def cmd(self):
        """
        Gets the cmd of this AppDefinition.
        ...
        :return: The cmd of this AppDefinition.
        :rtype: str
        """
        return self._cmd
    ...
    def cmd(self, cmd):
        """
        Sets the cmd of this AppDefinition.
        The command that is executed.  This value is wrapped by Mesos via `/bin/sh -c ${app.cmd}`.  Either `cmd` or `args` must be supplied. It is invalid to supply both `cmd` and `args` in the same app.

        :param cmd: The cmd of this AppDefinition.
        :type: str
        """
        self._cmd = cmd
    ...
    def constraints(self):
        """
        Gets the constraints of this AppDefinition.
        Valid constraint operators are one of UNIQUE, CLUSTER, GROUP_BY, LIKE, UNLIKE.

        :return: The constraints of this AppDefinition.
    ...
    def constraints(self, constraints):
        """
        Sets the constraints of this AppDefinition.
        Valid constraint operators are one of UNIQUE, CLUSTER, GROUP_BY, LIKE, UNLIKE.

        :param constraints: The constraints of this AppDefinition.
    ...
    def container(self):
        """
        Gets the container of this AppDefinition.


        :return: The container of this AppDefinition.
    ...
    def container(self, container):
        """
        Sets the container of this AppDefinition.


        :param container: The container of this AppDefinition.
    ...
    def cpus(self):
        """
        Gets the cpus of this AppDefinition.
        ...
        :return: The cpus of this AppDefinition.
        :rtype: float
        """
        return self._cpus
    ...
    def cpus(self, cpus):
        """
        Sets the cpus of this AppDefinition.
        The number of CPU shares this application needs per instance. This number does not have to be integer, but can be a fraction.

        :param cpus: The cpus of this AppDefinition.
        :type: float
        """
        self._cpus = cpus
    ...
    def dependencies(self):
        """
        Gets the dependencies of this AppDefinition.
        ...
        :return: The dependencies of this AppDefinition.
        :rtype: list[PathType]
        """
    ...
    def dependencies(self, dependencies):
        """
        Sets the dependencies of this AppDefinition.
        A list of services upon which this application depends. An order is derived from the dependencies for performing start/stop and upgrade of the application. For example, an application /a relies on the services /b which itself relies on /c. To start all 3 applications, first /c is started than /b than /a.

        :param dependencies: The dependencies of this AppDefinition.
        :type: list[PathType]
        """
    ...
    def disk(self, disk):
        """
        Sets the disk of this AppDefinition.
        How much disk space is needed for this application. This number does not have to be an integer, but can be a fraction.

        :param disk: The disk of this AppDefinition.
        :type: float
        """
        self._disk = disk
    ...
    def env(self):
        """
        Gets the env of this AppDefinition.


        :return: The env of this AppDefinition.
        :rtype: object
        """
        return self._env
    ...
    def env(self, env):
        """
        Sets the env of this AppDefinition.


        :param env: The env of this AppDefinition.
        :type: object
        """
        self._env = env
    ...
    def executor(self):
        """
        Gets the executor of this AppDefinition.
        ...
        :return: The executor of this AppDefinition.
        :rtype: str
        """
    ...
    def executor(self, executor):
        """
        Sets the executor of this AppDefinition.
        The executor to use to launch this application. Different executors are available. The simplest one (and the default if none is given) is //cmd, which takes the cmd and executes that on the shell level.

        :param executor: The executor of this AppDefinition.
        :type: str
        """
    ...
    def fetch(self):
        """
        Gets the fetch of this AppDefinition.
        Provided URIs are passed to Mesos fetcher module and resolved in runtime.

        :return: The fetch of this AppDefinition.
    ...
    def fetch(self, fetch):
        """
        Sets the fetch of this AppDefinition.
        Provided URIs are passed to Mesos fetcher module and resolved in runtime.

        :param fetch: The fetch of this AppDefinition.
    ...
    def health_checks(self):
        """
        Gets the health_checks of this AppDefinition.


        :return: The health_checks of this AppDefinition.
    ...
    def health_checks(self, health_checks):
        """
        Sets the health_checks of this AppDefinition.


        :param health_checks: The health_checks of this AppDefinition.
    ...
    def id(self):
        """
        Gets the id of this AppDefinition.
        ...
        :return: The id of this AppDefinition.
        :rtype: PathType
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this AppDefinition.
        :type: PathType
        """
        self._id = id
    ...
    def instances(self):
        """
        Gets the instances of this AppDefinition.
        ...
        :return: The instances of this AppDefinition.
        :rtype: int
        """
    ...
    def instances(self, instances):
        """
        Sets the instances of this AppDefinition.
        The number of instances of this application to start. Please note: this number can be changed any time as needed to scale the application.

        :param instances: The instances of this AppDefinition.
        :type: int
        """
    ...
    def labels(self):
        """
        Gets the labels of this AppDefinition.
        ...
        :return: The labels of this AppDefinition.
        :rtype: dict(str, str)
        """
        return self._labels
    ...
    def labels(self, labels):
        """
        Sets the labels of this AppDefinition.
        Attaching metadata to apps can be useful to expose additional information to other services, so we added the ability to place labels on apps (for example, you could label apps staging and production to mark services by their position in the pipeline).

        :param labels: The labels of this AppDefinition.
        :type: dict(str, str)
        """
        self._labels = labels
    ...
    def max_launch_delay_seconds(self):
        """
        Gets the max_launch_delay_seconds of this AppDefinition.
        Configures exponential backoff behavior when launching potentially sick apps. This prevents sandboxes associated with consecutively failing tasks from filling up the hard disk on Mesos slaves. The backoff period is multiplied by the factor for each consecutive failure until it reaches maxLaunchDelaySeconds. This applies also to tasks that are killed due to failing too many health checks.

        :return: The max_launch_delay_seconds of this AppDefinition.
        :rtype: int
        """
    ...
    def max_launch_delay_seconds(self, max_launch_delay_seconds):
        """
        Sets the max_launch_delay_seconds of this AppDefinition.
        Configures exponential backoff behavior when launching potentially sick apps. This prevents sandboxes associated with consecutively failing tasks from filling up the hard disk on Mesos slaves. The backoff period is multiplied by the factor for each consecutive failure until it reaches maxLaunchDelaySeconds. This applies also to tasks that are killed due to failing too many health checks.

        :param max_launch_delay_seconds: The max_launch_delay_seconds of this AppDefinition.
        :type: int
        """
    ...
    def mem(self, mem):
        """
        Sets the mem of this AppDefinition.
        The amount of memory in MB that is needed for the application per instance.

        :param mem: The mem of this AppDefinition.
        :type: float
        """
        self._mem = mem
    ...
    def ip_address(self):
        """
        Gets the ip_address of this AppDefinition.


        :return: The ip_address of this AppDefinition.
    ...
    def ip_address(self, ip_address):
        """
        Sets the ip_address of this AppDefinition.


        :param ip_address: The ip_address of this AppDefinition.
    ...
    def ports(self):
        """
        Gets the ports of this AppDefinition.
        ...
        :return: The ports of this AppDefinition.
        :rtype: list[int]
        """
        return self._ports
    ...
    def ports(self, ports):
        """
        Sets the ports of this AppDefinition.
        An array of required port resources on the agent host. The number of items in the array determines how many dynamic ports are allocated for every task. For every port that is zero, a globally unique (cluster-wide) port is assigned and provided as part of the app definition to be used in load balancing definitions.

        :param ports: The ports of this AppDefinition.
        :type: list[int]
        """
        self._ports = ports
    ...
    def residency(self):
        """
        Gets the residency of this AppDefinition.


        :return: The residency of this AppDefinition.
    ...
    def residency(self, residency):
        """
        Sets the residency of this AppDefinition.


        :param residency: The residency of this AppDefinition.
    ...
    def require_ports(self):
        """
        Gets the require_ports of this AppDefinition.
        ...
        :return: The require_ports of this AppDefinition.
        :rtype: bool
        """
    ...
    def require_ports(self, require_ports):
        """
        Sets the require_ports of this AppDefinition.
        Normally, the host ports of your tasks are automatically assigned. This corresponds to the requirePorts value false which is the default. If you need more control and want to specify your host ports in advance, you can set requirePorts to true. This way the ports you have specified are used as host ports. That also means that Marathon can schedule the associated tasks only on hosts that have the specified ports available.

        :param require_ports: The require_ports of this AppDefinition.
        :type: bool
        """
    ...
    def store_urls(self, store_urls):
        """
        Sets the store_urls of this AppDefinition.
        URL's that have to be resolved and put into the artifact store, before the task will be started.

        :param store_urls: The store_urls of this AppDefinition.
        :type: list[str]
        """
    ...
    def upgrade_strategy(self):
        """
        Gets the upgrade_strategy of this AppDefinition.


        :return: The upgrade_strategy of this AppDefinition.
    ...
    def upgrade_strategy(self, upgrade_strategy):
        """
        Sets the upgrade_strategy of this AppDefinition.


        :param upgrade_strategy: The upgrade_strategy of this AppDefinition.
    ...
    def uris(self):
        """
        Gets the uris of this AppDefinition.
        ...
        :return: The uris of this AppDefinition.
        :rtype: list[str]
        """
        return self._uris
    ...
    def uris(self, uris):
        """
        Sets the uris of this AppDefinition.
        URIs defined here are resolved, before the application gets started. If the application has external dependencies, they should be defined here.

        :param uris: The uris of this AppDefinition.
        :type: list[str]
        """
        self._uris = uris
    ...
    def user(self):
        """
        Gets the user of this AppDefinition.
        The user to use to run the tasks on the agent.

        :return: The user of this AppDefinition.
        :rtype: str
        """
        return self._user
    ...
    def user(self, user):
        """
        Sets the user of this AppDefinition.
        The user to use to run the tasks on the agent.

        :param user: The user of this AppDefinition.
        :type: str
        """
        self._user = user
    ...
    def version(self):
        """
        Gets the version of this AppDefinition.
        The version of this definition.

        :return: The version of this AppDefinition.
        :rtype: datetime
        """
    ...
    def version(self, version):
        """
        Sets the version of this AppDefinition.
        The version of this definition.

        :param version: The version of this AppDefinition.
        :type: datetime
        """
    ...
    def version_info(self):
        """
        Gets the version_info of this AppDefinition.


        :return: The version_info of this AppDefinition.
    ...
    def version_info(self, version_info):
        """
        Sets the version_info of this AppDefinition.


        :param version_info: The version_info of this AppDefinition.
