...
class V2appsVersionInfo(object):
    """
    ...
    def __init__(self):
        """
        V2appsVersionInfo - a model defined in Swagger
    ...
    def last_scaling_at(self, last_scaling_at):
        """
        Sets the last_scaling_at of this V2appsVersionInfo.
        Contains the time stamp of the last change to this app which was not simply a scaling or a restarting configuration.

        :param last_scaling_at: The last_scaling_at of this V2appsVersionInfo.
        :type: datetime
        """
    ...
    def last_config_change_at(self):
        """
        Gets the last_config_change_at of this V2appsVersionInfo.
        ...
        :return: The last_config_change_at of this V2appsVersionInfo.
        :rtype: datetime
        """
    ...
    def last_config_change_at(self, last_config_change_at):
        """
        Sets the last_config_change_at of this V2appsVersionInfo.
        Contains the time stamp of the last change including changes like scaling or restarting the app. Since our versions are time based, this is currently equal to version.

        :param last_config_change_at: The last_config_change_at of this V2appsVersionInfo.
        :type: datetime
        """
