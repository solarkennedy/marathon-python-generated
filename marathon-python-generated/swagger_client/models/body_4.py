...
class Body4(object):
    ...
    def apps(self, apps):
        """
        Sets the apps of this Body4.
        The list of AppDefinitions in this group. See AppDefinition.json for the schema.

        :param apps: The apps of this Body4.
    ...
    def groups(self, groups):
        """
        Sets the groups of this Body4.
        Groups can build a tree. Each group can contain sub-groups. The sub-groups are defined here.

        :param groups: The groups of this Body4.
        :type: list[]
        """
        self._groups = groups
    ...
    def dependencies(self):
        """
        Gets the dependencies of this Body4.
        ...
        :return: The dependencies of this Body4.
        :rtype: list[PathType]
        """
    ...
    def dependencies(self, dependencies):
        """
        Sets the dependencies of this Body4.
        A list of services upon which this application depends. An order is derived from the dependencies for performing start/stop and upgrade of the application. For example, an application /a relies on the services /b which itself relies on /c. To start all 3 applications, first /c is started than /b than /a.

        :param dependencies: The dependencies of this Body4.
        :type: list[PathType]
        """
    ...
    def version(self):
        """
        Gets the version of this Body4.
        The version of this definition.

        :return: The version of this Body4.
        :rtype: datetime
        """
    ...
    def version(self, version):
        """
        Sets the version of this Body4.
        The version of this definition.

        :param version: The version of this Body4.
        :type: datetime
        """
